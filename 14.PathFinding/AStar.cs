...
namespace _14.PathFinding
{
    internal class AStar
    {
        ...
        ********************************************************/
        ...
        // 왜 그냥 유클리드를 쓰지 않느냐?
        // 제곱근 연산이 들어가 계산이 오래걸린다.
        // 직선을 10으로 대각선을 14로 점수 산정을 하면 후보를 줄이는 유사한 효과를 가져오면서
        // 빠르게 연산이 가능하다.
        ...
        private class ASNode
        {
            ...
            public int g;               // 지금까지의 이동거리
            public int h;               // 목표까지의 예상거리 (기법이 다 다름)
            public int f;               // 총 예상 거리
